        ...
        <form:form modelAttribute="visit" class="form-horizontal">
            <div class="form-group has-feedback">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <form:select path="vet" class="form-control">
                            <form:option value="" label="-- None --"/>
                            <c:forEach var="vet" items="${vets}">
                                <form:option value="${vet.id}" label="${vet.firstName} ${vet.lastName}"/>
                            </c:forEach>
                        </form:select>
                    </div>
                </div>
            ...
            <c:forEach var="visit" items="${visit.pet.visits}">
                <c:if test="${!visit['new']}">
                    <tr>
                        ...
                        <td><c:out value="${visit.vet != null ? visit.vet.firstName.concat(' ').concat(visit.vet.lastName) : ''}"/></td>
                    </tr>
                </c:if>
            </c:forEach>
        </table>

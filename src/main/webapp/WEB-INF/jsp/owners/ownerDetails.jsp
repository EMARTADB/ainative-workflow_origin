            ...
            <tr>
                <th scope="col">
                    <dl class="dl-horizontal">
                        ...
                        <c:if test="${petPhotoIds.contains(pet.id)}">
                            <dt>Photo</dt>
                            <dd>
                                <img src="/owners/${owner.id}/pets/${pet.id}/photo"
                                     alt="Photo of ${pet.name}"
                                     style="max-height:100px; max-width:100px;"/>
                                <form method="post"
                                      action="/owners/${owner.id}/pets/${pet.id}/photo/delete"
                                      style="display:inline;">
                                    <button type="submit" class="btn btn-xs btn-danger">Delete Photo</button>
                                </form>
                            </dd>
                        </c:if>
                        <dt>Microchip ID</dt>
                        <dd><c:choose><c:when test="${not empty pet.microchipId}"><c:out value="${pet.microchipId}"/></c:when><c:otherwise>&#8212;</c:otherwise></c:choose></dd>
                    </dl>
                </th>
                <td>
                    <table class="table-condensed" aria-describedby="petsAndVisits">
                        ...
                        <tr>
                            ...
                            <th id="visitVet">Veterinarian</th>
                        </tr>
                        </thead>
                        ...
                        <tr>
                            ...
                            <td>
                                <spring:url value="/pets/{petId}/transfer" var="transferUrl">
                                    <spring:param name="petId" value="${pet.id}"/>
                                </spring:url>
